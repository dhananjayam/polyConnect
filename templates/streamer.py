...
def main():
	#polygon_api_key = os.environ.get("yWq25Y3mVWiADXve5h3bjKEp_3q1Tho9rM4U_R", "my-api-key")
	cluster = "/stocks"
	symbols_str = "T.*"
	streamer = StocksStreamer(api_key='yWq25Y3mVWiADXve5h3bjKEp_3q1Tho9rM4U_R', cluster=cluster, symbols_str=symbols_str)
	streamer.start()
